...
open(unit=10, file='./TimeCheck_Alg1.raw', action="write")
!*************************************************************
...
! save draws                                                      *
!******************************************************************
open(unit=16, file='./Draws_part1_bay_SPanel_alg1.raw', action="write")
open(unit=7, file='./Draws_part2_bay_SPanel_alg1.raw', action="write")
do i = 1, ndraw-nburn
...
open(unit=3, file='./GewekeResults_bay_spanel_alg1', action="write")
...
! generate random sample from N(0,1)
 ...
 !***************************************************
  ...
  DO i = 1, N
   ...
   inversePsi = (sigma_mu_sq*sigma_sq)/ &
                (sigma_mu_sq*REAL(NObsCity(i)) + sigma_sq)
   MU1 = (sigma_mu_sq*DTBQ)/(sigma_mu_sq*REAL(NObsCity(i)) + sigma_sq)
