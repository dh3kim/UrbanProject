...
print *, "   * The average runtime is  sec. per 100 draws"
print *, "   ************************************************   "
...
!******************************************************************
open(unit=16, file='./Draws_part1_bay_re_alg1.raw', action="write")
open(unit=7, file='./Draws_part2_bay_re_alg1.raw', action="write")
do i = 1, ndraw-nburn
...
open(unit=3, file='./GewekeResults_bay_re_alg1', action="write")
...
! generate random sample from N(0,1)
 ...
 !**************************************************
   ...
   sigma_u_sq = p1/(2.0 * random_gamma1(h1/2.0, First))
